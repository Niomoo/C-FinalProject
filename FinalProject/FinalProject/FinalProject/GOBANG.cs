...
namespace  FinalProject
{
    public partial class GOBANG : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.BackColor = Color.FromArgb(213, 179, 142);
            makeBoard();
        }
        void makeBoard()
        {
            ...
            this.Text = "Press F2:PVC, F3:PVP, F5:Refresh               Current Mode:PVC";
            ...
            switch (e.KeyCode)
            {
                ...
                case Keys.F3:
                    if (MessageBox.Show("Player VS Player", "", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        Panel1.Refresh();
                        mode = 0;   
                        this.Text = "Press F2:PVC, F3:PVP, F5:Refresh           Current Mode:PVP";
                    }
                    break;
                case Keys.F5:
                    Panel1.Refresh();
        ...
        private Point AI1(int[,] B)//格式[橫,直] 0=空 1=黑 2=白
        {
            ...
            ai1.board = B;//匯入當前棋盤
            ai1.computer();
            return new Point(ai1.loc.X, ai1.loc.Y); 
        }
        
        private bool checkwin(Point P)
        {
            int t;
            if (turn) t = 1;
            else t = 2;
